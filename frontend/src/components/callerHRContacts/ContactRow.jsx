...
const ContactRow = ({ contact, currentUser }) => {
  return (
    <tr className="hover:bg-gray-50">
      ...
      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-800">{contact.company}</td>
      <td className="px-6 py-4 whitespace-nowrap">
      ...
      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
        <ContactActionsDropdown contact={contact} currentUser={currentUser} />
      </td>
    </tr>
  );
};
